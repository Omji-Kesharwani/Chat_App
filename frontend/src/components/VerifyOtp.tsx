    ...
    <div className='min-h-screen bg-gray-900  flex items-center justify-center p-4 '>
      ...
      <div className='bg-gray-800 border-gray-700 rounded-lg p-8'>
        <div className='text-center mb-8 relative'>
          ...
          onClick={()=>router.push("/login")}><ChevronLeft className="w-6 h-6 "/></button>
        ...
        onSubmit={handleSubmit}>
           ...
           {
            error && <div className="bg-red-900 border-red-700 rounded-lg border p-3">
        ...
        <div className="mt-6 text-center">
          <p className='text-gray-400 text-sm mb-4'>Din't recieve the code?</p>
          {
