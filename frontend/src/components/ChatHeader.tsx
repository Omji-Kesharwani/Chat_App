...
return (
  <>
    ...
    {/* chat header */}
    <div className='mb-3 bg-gray-800 rounded-lg border-gray-700 p-3 '>
      <div className="flex items-center gap-4">
       {
         user ?(
          ...
          <div className='relative'>
            ...
            {
              isOnlineUser && (
                <span className='absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-green-500 border-2 border-gray-500 '>
                  <span className='absolute inset-0 rounded-full bg-green-500 animate-ping opactiy-75'></span>
                </span>
              )
            }
          </div>
