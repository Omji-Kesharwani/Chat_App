...
import { CornerDownRight, CornerUpLeft, LogOut, MessageCircle, Plus, PlusIcon, Search, UserCircle, X } from 'lucide-react';
...
({
  ...
  // createChat is passed as a prop, so no need to define it here.
  // Remove this function to avoid shadowing the prop.

  return (
   <aside className={`fixed z-20 sm:static top-0 left-0 h-screen w-80 bg-gray-900 border-r border-gray-700 transform ${sidebarOpen ? "translate-x-0"
   :"-translate-x-full"
  ...
  <div className="flex-1 overflow-hidden px-4 py-2 ">
    {
     showAllUsers?<div className='space-y-4 h-full'>
      <div className='relative'>
        ...
        className='w-full pl-10 pr-4 py-2 bg-gray-800 border border-gray-700 text-white placeholder-gray-400 outline-none '
        value={searchQuery}
    ...
    <div className="p-4 border-t- border-gray-700 space-y-2 ">
      ...
      <button onClick={handleLogout} className='w-full flex items-center gap-3 py-3 px-4 rounded-lg hover:bg-red-600 transition-colors text-red-500 hover:text-white'>
